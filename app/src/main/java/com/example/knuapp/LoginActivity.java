...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private ShowGradeTask gradeTask=null;
    // UI references.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResult = (TextView) findViewById(R.id.Debug);
    ...
    public class UserLoginTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                //  String Deb=EntityUtils.toString(httpResponse.getEntity(), "UTF-8");
...
//                        i++;
//                        //Log.v("TAG", "this1 " + i + " : " + bufferedStrChunk);
//                        stringBuilder.append(bufferedStrChunk);
//                    }

               // Log.v("TAG","Deb 21: "+ Deb);/////<==  이곳에서   서버에서  보내온 메시지를 확인해 볼 수 있다..
...
//                });
        ...
        protected void onPostExecute(String result) {
            ...
            gradeTask=new ShowGradeTask(txtResult);
            gradeTask.execute();
